	...
	function whySignUp(){
		...
		var closer = document.createElement("button");//added 
		closer.innerText="Close";//added 
		closer.setAttribute("onclick","MarcusCloser()");//added 
		closer.setAttribute("class","MarcusButtonCloser btn btn-danger");//added 
		closer.setAttribute("id","MarcusButtonCloser");//added 
		
		h4.appendChild(h4Text);
		document.getElementById("infoWhy").appendChild(h4);
		document.getElementById("infoWhy").appendChild(closer);//added 
		document.getElementById("infoWhy").style.display = "block";
	}
	//end of the info creation
	//close the WHY SIGN UP box
	//added  remove incase error
	function MarcusCloser(){
		document.getElementById("infoWhy").style.display = "";
		document.querySelector(".MarcusButtonCloser").style.display="";
	}
	...
	if (checkUsername() && comparePass() && checkEmail() && checkFirst() && checkGen() == true) {
